...
export default function BottomNav() {
    ...
    const itemStyle = (path: string) => [
        styles.navItem,
        isActive(path) && styles.activeItem,
    ];
    const labelStyle = (path: string) => [
        styles.label,
        isActive(path) && styles.activeText,
    ];
    const iconColor = (path: string) => (isActive(path) ? "#FFFFFF" : "#000000");
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                <Text style={labelStyle("/home")}>Início</Text>
            </Pressable>

            {/* Publicar Item */}
            <Pressable
                style={itemStyle("/PublicItem")}
                onPress={() => router.push("/PublicItem")}
            >
                <Svg width={16} height={16} viewBox="0 0 16 16" fill={iconColor("/PublicItem")}>
                    <Path fillRule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
                </Svg>
                <Text style={labelStyle("/PublicItem")}>Itens</Text>
            </Pressable>

            {/* Trocas (sem rota ainda) */}
            ...
            >
                <Svg width={16} height={16} viewBox="0 0 16 16" fill={iconColor("/profile")}>
